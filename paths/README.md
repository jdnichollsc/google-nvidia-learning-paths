...
<table>
  ...
  <tr>
    <td>
      <a href="./INFERENCE/comic/INFERENCE.pdf">
        <img src="./INFERENCE/comic/00-cover.png" width="300">
      </a>
    </td>
  </tr>
</table>
...
### [Intro to Inference: How to Run AI Models on a GPU](./INFERENCE/)
...
**Notebooks:**
- [`01_foundations_of_inference.ipynb`](./INFERENCE/01_foundations_of_inference.ipynb) — CPU vs GPU inference, pipeline components, batching fundamentals
- [`02_performance_metrics.ipynb`](./INFERENCE/02_performance_metrics.ipynb) — Latency, throughput, and finding the knee point

**Articles:**
- [Choosing the right format for your AI model](./INFERENCE/INFERENCE_FORMATS_GUIDE.md) — A comprehensive guide to AI inference formats
